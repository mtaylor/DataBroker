...
{
   protected static String OPENSHIFT_USERNAME = "openshift.username";

   protected static String OPENSHIFT_PASSWORD = "openshift.password";

   protected static String OPENSHIFT_DOMAIN = "openshift.domain";
   ...
   public BaseOpenShiftApplicationImpl(String appName)
   {
      username = System.getProperty("openshift.username");
      password = System.getProperty("openshift.password");
      domainName = System.getProperty("openshift.domain");
